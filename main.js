...
let makeItalic = () => {
  let elements = document.getElementsByClassName('even');
...
let createBorders = () => {
  let myPage = document.getElementById('myPage');
  let table = myPage.querySelector('table');
...
let getTheListItem = (num1, num2) => {
  let myPage = document.getElementById('myPage');
  let list = myPage.querySelector('ul:nth-of-type(2)');
  let item = list.querySelector('li:nth-child(2)');
  return item;
};
